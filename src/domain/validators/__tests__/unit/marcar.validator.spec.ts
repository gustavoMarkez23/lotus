...
import { mockMarcaProps } from '@/domain/entities/tests/mocks/mock-marca'
import { MarcaRules, type MarcaValidator, MarcaValidatorFactory } from '@/domain/validators/marcar.validator'
